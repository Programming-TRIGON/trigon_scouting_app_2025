...
class FirebaseHandler {
  ...
  static Future<User?> signUp(String email, String password, String name, String role) async {
    try {
      final cred = await authInstance.createUserWithEmailAndPassword(email: email.trim(), password: password.trim());
  ...
  static Future<User?> logInWithEmailAndPassword(String email, String password) async {
    try {
      final cred = await authInstance.signInWithEmailAndPassword(email: email.trim(), password: password.trim());
      return cred.user;
    } catch(e) {
      log("Something went wrong.");
    }
