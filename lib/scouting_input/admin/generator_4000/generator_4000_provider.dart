...
enum Generator4000Page {
  scoutersGenerator(title: "מחלל הסקאוטרים", icon: Icon(CupertinoIcons.person_2_fill)),
  unitsGenerator(title: "מחלל הפלוגות", icon: Icon(CupertinoIcons.building_2_fill)),
